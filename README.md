...
### pm
Project management pipeline for large/complex work: PRD interview, multi-persona research, ordered task generation, stack-aware execution, and independent verification. Supports versioned milestones (v1, v2, ...) and multi-developer team workflow via `/pm-claim`. Thirteen slash commands prefixed `/pm-`.
